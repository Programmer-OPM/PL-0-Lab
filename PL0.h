...
#define NRW 11 + 2 + 2 + 1	// number of reserved words  徐卓+2 //+1 by zhf
#define TXMAX 500		// length of identifier table
#define MAXNUMLEN 14	// maximum number of digits in numbers
#define NSYM 10 + 1 + 2 + 1 // maximum number of symbols in array ssym and csym //+1 by zhf
...
enum symtype
{
	...
	SYM_OR,	  //
	SYM_NOT,  //
    SYM_FOR, //added by zhf
    SYM_COLON //added by zhf
};
...
char *err_msg[] =
	{
		...
		/* 26 */ "'(' expected.", //added by zhf
		/* 27 */ "':' expected.", //added by zhf
		/* 28 */ "Missing number(s) in 'for' statement.",//added by zhf
		/* 29 */ "Expected 'var' in for statement", //added by zhf
		/* 30 */ "",
		/* 31 */ "",
...
char *word[NRW + 1] =
{
		...
		"odd", "procedure", "then", "var", "while", "goto", "else", "print", "random" /*添加goto else*/, "for"/*added by zhf*/
};

int wsym[NRW + 1] =
{
		SYM_NULL, SYM_BEGIN, SYM_CALL, SYM_CONST, SYM_DO, SYM_END,
		SYM_IF, SYM_ODD, SYM_PROCEDURE, SYM_THEN, SYM_VAR, SYM_WHILE, SYM_GOTO, SYM_ELSE, SYM_PRT, SYM_RND/*添加*/, SYM_FOR/*added by zhf*/
};

int ssym[NSYM + 1] =
{
		SYM_NULL, SYM_PLUS, SYM_MINUS, SYM_TIMES, SYM_SLASH,
		SYM_LPAREN, SYM_RPAREN, SYM_LBRAC, SYM_RBRAC, SYM_EQU, SYM_COMMA, SYM_PERIOD, SYM_SEMICOLON, SYM_NOT, SYM_COLON/*added by zhf*/
};
